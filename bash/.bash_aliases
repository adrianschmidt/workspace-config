...
alias wcinstallbuild="cd ~/src/lime-webclient/ && nvm use && npm i && cd frontend/new-webclient && npm i && npm run build && cd ../admin && npm i && npm run build && cd ~/src/lime-webclient/"
